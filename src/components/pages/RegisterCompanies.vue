...
const subtitleText = ref("Cadastro - Empresas"); // título controlado pelo pai
...
const gridColumns = [
  { key: "numeroempresa", label: "Numéro da empresa" },
...
const minhasAcoesDaTela = [
  { name: "visualizar", label: "Visualizar", icon: AtomEyeIcon },
  {
    name: "edit",
    label: "Editar",
    icon: EditIcon,
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar empresa"
        class="mt-15"
        :add-icon="AtomPlusIcon"
        @add="funcaoParaAdicionar"
      />
