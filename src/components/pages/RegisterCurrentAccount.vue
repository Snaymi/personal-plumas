...
const subtitleText = ref("Cadastro - Conta Correntes"); // título controlado pelo pai
...
const gridColumns = [
  { key: "id", label: "ID" },
  { key: "numeroconta", label: "Número conta" },
  { key: "empresa", label: "Empresa" },
  { key: "bancoofx", label: "Banco OFX" },
  { key: "acctid", label: "ACCTID (OFX)" },
];
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar conta corrente"
        class="mt-15"
        :add-icon="AtomPlusIcon"
        @add="funcaoParaAdicionar"
      />
