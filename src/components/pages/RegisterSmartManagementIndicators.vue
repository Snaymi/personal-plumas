...
const subtitleText = ref("Cadastro - Indicadodores da Gestão Inteligente "); // título controlado pelo pai
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar pergunta"
        class="mt-15"
      />
    </div>
  </div>
