...
const subtitleText = ref("Cadastro - Lançamentos Contábeis"); // título controlado pelo pai
...
const gridColumns = [
  ...
  { key: "historicolanc", label: "Histórico lanç." },
  { key: "credito", label: "Crédito" },
  { key: "debito", label: "Débito" },
  { key: "categoria", label: "Categoria" },
  { key: "tipo", label: "Tipo" },
  { key: "lancamento", label: "Lançamento" },
  { key: "tipodeconta", label: "Tipo de conta" },
];
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar lançamentos contábil"
        class="mt-15"
        :add-icon="PlusIcon"
        @add="funcaoParaAdicionar"
      />
