...
const subtitleText = ref("Cadastro - Código dos Lançamentos Folhas"); // título controlado pelo pai
...
const gridColumns = [
  ...
  { key: "contadebito", label: "Conta débito" },
  { key: "contacredito", label: "Conta crédito" },
  { key: "contadesconto", label: "Conta desconto" },
];
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar código do lançamento Folha"
        class="mt-15"
        :add-icon="AtomPlusIcon"
        @add="funcaoParaAdicionar"
      />
