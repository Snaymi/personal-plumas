...
const subtitleText = ref("Cadastro - Perguntas do Relatório de Visitas"); // título controlado pelo pai
...
const gridColumns = [
  ...
  { key: "tipopergunta", label: "Tipo pergunta" },
  { key: "perguntadupla", label: "Pergunta dupla" },
];
