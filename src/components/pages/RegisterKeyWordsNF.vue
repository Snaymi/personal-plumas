...
const subtitleText = ref("Cadastro - Palavras Chaves NF"); // título controlado pelo pai

// 🔹 dados e colunas de exemplo só para renderizar o grid
const gridData = ref([
  {
    indicador: "lore ipsum",
    parametroideal: "lore ipsum",
    sinalideal: "lore ipsum",
    parametrocritico: "lore ipsum",
    sinalcritico: "lore ipsum",
    msgideal: "lore ipsum",
    msgatencao: "lore ipsum",
    msgcritico: "lore ipsum",
    perguntadupla: "lore ipsum",
    tipopergunta: "lore ipsum",
    respostas: "lore ipsum",
    pergunta: "lore ipsum",
    ordem: "lore ipsum",
    ...
    empresa: "lore ipsum",
    numeroempresa: "123",
    razaosocial: "lore ipsum",
    nomefantasia: "loreipsum",
    cnpj: "123",
    bancoofx: "lore ipsum",
    acctid: "lore ipsum",
    agencia: "lore ipsum",
  ...
  >
    <div class="w-full">
      ...
      <OrganismGridView
        ...
        add-button-text="Adicionar palavra chave NF"
        class="mt-15"
        :add-icon="AtomPlusIcon"
        @add="funcaoParaAdicionar"
      />
